...
begin
  ...
  for rul in
    select * from (values
      ...
      ('SQ *',             'Comida'),
      ('CLIP MX',          'Comida'),
      -- palabras genéricas: atrapan comercios que nunca has visto, incluso
      -- en el extranjero, sin tener que darlos de alta uno por uno
      ('TAQUERIA',         'Comida'),
      ('TACO',             'Comida'),
      ('PIZZA',            'Comida'),
      ('SUSHI',            'Comida'),
      ...
      ('DRIVE IN',         'Comida'),
      ('FOOD',             'Comida'),
      -- Tampoco 'PHO': se metía en "PHOTO". Los patrones de 3 letras con
      -- `contains` casi siempre salen caros.
      ('UBER',             'Transporte'),
      ('DIDI',             'Transporte'),
      ('CABIFY',           'Transporte'),
      ('METRO',            'Transporte'),
      ...
      ('PARKING',          'Transporte'),   -- gana sobre nada por ser más largo
      ('ESTACIONAMIENTO',  'Transporte'),
      ('CASETA',           'Transporte'),
      ('SHELL',            'Transporte'),
      -- Nada de 'MOBIL' aquí: atrapaba "T-MOBILE PARK" (un estadio) y lo
      -- mandaba a Transporte. Con `contains`, los patrones cortos muerden.
      ...
      ('MUSEUM',           'Entretenimiento'),
      ('MUSEO',            'Entretenimiento'),
      ('THEATER',          'Entretenimiento'),
      ('TEATRO',           'Entretenimiento'),
      ('BILLIARDS',        'Entretenimiento'),
      ('BOWLING',          'Entretenimiento'),
      ('KAYAK TOURS',      'Entretenimiento'),
      ('ZOO',              'Entretenimiento'),
      ('ACUARIO',          'Entretenimiento'),
      ('TICKET',           'Entretenimiento'),
      ('STADIUM',          'Entretenimiento'),
